...
<div>
          <React.Fragment >
            <MaterialTable style={{marginLeft:'10px', marginRight:'10px', marginLeft:'10px', marginTop:'100px'}}
              ...
              columns={[
                { title: 'Username', field: 'un' },
                { title: 'School name', field: 'sn' },
                { title: 'Number of students', field: 's' },
                { title: 'Number of vehciles', field: 'v' },
                { title: 'Type', field: 't' },
                { title: 'Address', field: 'a' },
