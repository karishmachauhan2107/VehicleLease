...
class Sallot extends Component{
    ...
    Axios.get('http://localhost:8080/examples/Srecord.jsp',{params:data}).then(response=>{
...
<div key>
      ...
      <CardContent>
<label > Student Id : {ag.sid}</label></CardContent> <br></br>
<CardContent><label>Vehicle Id : {ag.vid}</label></CardContent><br></br>
<CardContent><label>Stopage : {ag.stoppage}</label></CardContent><br></br>
<CardContent><label>Pick-Up Time : {ag.dt}</label></CardContent><br></br>
<CardContent><label>Drop-Off Time : {ag.dot}</label></CardContent>
</Card>
      </div>):(null))}
    </div>
    )}
